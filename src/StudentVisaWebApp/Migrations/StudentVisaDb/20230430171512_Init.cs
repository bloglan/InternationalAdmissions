        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Passport_DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Passport_PlaceOfBirth = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Passport_DateOfIssue = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Passport_DateOfExpiration = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Visa_EnterBefore = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Visa_DurationOfEachStay = table.Column<int>(type: "int", nullable: false),
                    Visa_IssueDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    Visa_BirthDate = table.Column<DateTime>(type: "datetime2", nullable: false),
